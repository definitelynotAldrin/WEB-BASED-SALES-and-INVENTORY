...
if (isset($_POST['order_id'])) {
    ...
    try {
        ...
        $sql_update_order = "UPDATE orders SET order_status = 'served' WHERE order_id = ?";
        ...
        if ($stmt_update_order->affected_rows > 0) {
            ...
            $sql_update_order_details = "UPDATE order_details SET order_item_status = 'served' WHERE order_item_status = 'process' AND order_id = ?";
